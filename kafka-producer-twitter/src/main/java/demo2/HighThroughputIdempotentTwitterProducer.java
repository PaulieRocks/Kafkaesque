...
public class HighThroughputIdempotentTwitterProducer {
    private String bootstrapServer="127.0.0.1:9092";
    private String topic="twitter_feed";

    public HighThroughputIdempotentTwitterProducer(){}

    Logger logger= LoggerFactory.getLogger(HighThroughputIdempotentTwitterProducer.class.getName());
    public static void main(String[] args) {
        System.out.println("Hey Twitter Bird");
        new HighThroughputIdempotentTwitterProducer().run();
    }
...
//Making HighThroughput Producer
    ...
    public Client createTwitterClient(BlockingQueue<String> msgQueue){
        ...
        // Optional: set up some followings and track terms
                List<String> terms = Lists.newArrayList("bitcoin","trump","india","tesla","sport","soccer","cricket");
